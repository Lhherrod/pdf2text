...
<div class="max-w-7xl mx-auto rounded-md">
    <a href="/spreadsheet-files" class="mb-1 block">go back...</a>
    <ul role="list" class="divide-y divide-gray-100 rounded-lg" style="background-color: rgb(157 174 210); opacity: 1">
        <li class="flex justify-between gap-x-6 py-5 px-5">
            <div class="flex gap-x-4 items-center">
                ...
                <img class="h-12 w-12 flex-none rounded-full bg-gray-50" src="excel_logo.png" alt="a picture of microsoft excel logo">
                <div class="min-w-0 flex-auto">
                    <p class="text-sm font-semibold leading-6 text-gray-500">
                        <?= htmlspecialchars($excel_file['name']) ?>
                    </p>

                    <footer class="mt-6">
                        <a href="/spreadsheet-file/edit?id=<?= $excel_file['id']?>" class="text-gray-500 border px-3 py-2 rounded border-current">Edit</a>
                    </footer>
