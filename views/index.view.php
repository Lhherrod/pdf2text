<!-- echo "<body style='display: grid; place-items: center; height: 100vh; margin: 0; font-family: sans-serif'></body>"; 
echo "<h1> welcome to the larrydev PDF Parser & Number Cruncher :)</h1>"; -->
    ...
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">larrydev PDF Parser & Number Cruncher :)</h2>
                <p class="mt-6 text-lg leading-8 text-gray-300">
                    PDF parser to extract text from bonified PDF files, and also a number cruncher for quick addition and subtraction for transactions for example.
                </p>
            </div>
