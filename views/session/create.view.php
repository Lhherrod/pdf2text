        ...
        <div class="overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="w-full sm:w-[400px] md:w-[500px] px-5 mx-auto text-center border-none">
                    <form id="demo-form" class="text-[blueviolet] border-none" action="/session" method="POST">
                        <div class="mb-3">
                            <input name="email" value="<?= old('email') ?>" type="text" placeholder="Your Email..." autofocus class="w-full rounded border-indigo-300 focus:border-indigo-300 focus:ring-indigo-300">
